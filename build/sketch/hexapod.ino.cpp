...
void setup();
#line 20 "/home/nithish/hexapod/Hexapod/hexapod_main/hexapod/hexapod/hexapod/hexapod/hexapod.ino"
void loop();
...
#line 62 "/home/nithish/hexapod/Hexapod/hexapod_main/hexapod/hexapod/hexapod/hexapod/hexapod.ino"
...
void moveLeg(int baseServoID, float jointAngles[3]) {
    ...
    sc.WritePos(9, 512, 0, 300); // Coxa
    sc.WritePos(8, 512, 0, 300); // Femur
    sc.WritePos(7, 512, 0, 300); // Tibia
